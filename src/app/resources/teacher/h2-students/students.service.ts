...
export class TeacherStudentService {
  ...
  async getAllStudents(
    ...
    const teacher = await this.userRepository.findOne({
      where: { id: userId },
      relations: { teacherInfo: { department: true } },
    });
    ...
    const teacherDepartmentId = teacher.teacherInfo?.department?.id;
    ...
    const dataSetup = await this.getDataSetup(teacherDepartmentId);
